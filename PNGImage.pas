    ...
    begin
      ...
      begin
        ...
        repeat
          ...
          // 24-Nov-24, Yaron Gur
          // Previous decleration didn't take bits into account when setting the source data input, eventually causing a crash.
          case Header.BitDepth of
             1 : Data := @ImageSource[i2 div 8];
             2 : Data := @ImageSource[i2 div 4];
             4 : Data := @ImageSource[i2 div 2];
            else Data := @ImageSource[i2];
          end;
